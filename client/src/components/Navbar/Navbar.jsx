...
export default function Navbar() {
  ...
  const handleLogout = async () => {
    try {
      ...
      if (typeof replaceUser === "function") replaceUser(guest);
      else if (typeof setUser === "function") setUser(guest);
          ...
          <ul className="hidden md:flex items-center gap-2">
            ...
            {user && !user.isGuest ? (
              <li className="relative" ref={dropdownRef}>
                ...
                {profileOpen && (
                  <div className="absolute right-0 mt-2 w-56 rounded-lg bg-black/90 ring-1 ring-white/10 shadow-xl overflow-hidden">
